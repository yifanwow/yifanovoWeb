...
const SocialLinks = () => {
  ...
  return (
    <div className="Icons">
      <a
        href="https://github.com/yifanwow"
        target="_blank"
      ...
      <a
        href="https://instagram.com/yifanovo_"
        target="_blank"
        rel="noopener noreferrer"
      ...
      <a
        href="https://steamcommunity.com/id/yifanovo/"
        target="_blank"
        rel="noopener noreferrer"
        className="InstagramStyle"
      >
      ...
      <a
        href="https://www.xiaohongshu.com/user/profile/5b2eb172f7e8b940e52e00c2"
        target="_blank"
        rel="noopener noreferrer"
        className="InstagramStyle"
      >
      ...
      >
        ...
        <img
          src="/img/wechat.jpg"
          alt="WeChat QR Code"
          className={`WeChatImage ${showWeChatImage ? "visible" : ""}`}
        />
      </div>
    </div>
  );
